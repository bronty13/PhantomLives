#!/bin/bash
# Reinstall the freshly-built MessagesExporterGUI.app into /Applications/.
#
# Usage:
...
SRC="$PWD/MessagesExporterGUI.app"
DST="/Applications/MessagesExporterGUI.app"
OPEN_AFTER=1
for arg in "$@"; do
    case "$arg" in
...
echo "Quitting any running MessagesExporterGUI..."
osascript -e 'tell application "MessagesExporterGUI" to quit' >/dev/null 2>&1 || true
sleep 1
