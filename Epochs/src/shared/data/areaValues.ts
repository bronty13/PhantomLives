...
// This is REAL data (uncopyrightable facts), transcribed from the manual.
...
export const AREA_VALUES: Record<AreaId, EpochTuple> = {
  ...
  middle_east:      [ 2, 3, 3, 3, 3, 2, 1 ],
  north_africa:     [ 1, 2, 2, 2, 2, 2, 1 ],
  china:            [ 1, 2, 3, 3, 3, 3, 3 ],
  india:            [ 1, 2, 3, 3, 3, 3, 3 ],
  southern_europe:  [ 1, 2, 3, 3, 3, 3, 2 ],
  northern_europe:  [ 0, 0, 1, 2, 2, 3, 4 ],
  southeast_asia:   [ 0, 0, 1, 2, 2, 2, 2 ],
  eurasia:          [ 0, 0, 0, 0, 1, 1, 2 ],
  north_america:    [ 0, 0, 0, 0, 1, 1, 3 ],
  south_america:    [ 0, 0, 0, 0, 1, 2, 2 ],
  nippon:           [ 0, 0, 0, 0, 1, 1, 2 ],
