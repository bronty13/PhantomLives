...
The `ThisDeviceOnly` items are wrapped with the UID so they cannot ride a backup to another device — which is exactly why a restored iPhone re-prompts for Wi-Fi passwords and some tokens. Full keychain mechanics are in [[keychain-on-ios]]; here, just know the keybag is the shared vault for *both* file class keys and keychain class keys.
...
---
*Related lessons: [[sep-sepos-deep-dive]] | [[storage-nand-aes-effaceable]] | [[passcode-bfu-afu-and-inactivity]] | [[keychain-on-ios]] | [[apfs-on-ios-volumes]] | [[bfu-vs-afu-and-data-protection-classes]] | [[decrypting-backups-and-images]] | [[icloud-acquisition-and-advanced-data-protection]] | [[advanced-protections-lockdown-sdp-adp]]*
