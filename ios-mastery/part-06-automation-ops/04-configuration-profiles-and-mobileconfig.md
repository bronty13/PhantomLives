...
| `com.apple.mdm` | **MDM enrollment** (see [[02-mdm-supervision-and-abm]]) | Hands a remote actor the device |
...
- **Unified logs** (`com.apple.ManagedConfiguration` / `profiled` / `mdmd` subsystems) record install, apply, and removal events with timestamps — cross-reference [[12-unified-logs-sysdiagnose-crash-network]]. A sysdiagnose captures a `ManagedConfiguration` / profiles snapshot too.
...
---
*Related lessons: [[02-mdm-supervision-and-abm]] | [[03-declarative-device-management]] | [[04-code-signing-amfi-entitlements]] | [[03-certificate-pinning-and-bypass]] | [[02-traffic-interception-and-tls]] | [[06-lockdown-mode-and-enterprise-posture]]*
