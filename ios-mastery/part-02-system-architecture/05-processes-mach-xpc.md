...
4. **Fidelity check:** real-device RunningBoard also drives the *actual* jetsam kill path under memory pressure; the Simulator won't kill for memory the way a phone does. You're seeing the bookkeeping, not the consequence — see [[06-memory-jetsam-app-lifecycle]].
...
5. **Fidelity check:** this is the *real* device artifact the Simulator can't produce — but it's a single instant, not a timeline. The behavioral timeline lives in the Biome/knowledgeC and unified-log stores ([[01-knowledgec-db-deep-dive]], [[12-unified-logs-sysdiagnose-crash-network]]).
...
- **RunningBoard**, not SpringBoard, owns the process lifecycle: assertions, Darwin roles, and jetsam priority — the input to the kill path in [[06-memory-jetsam-app-lifecycle]].
...
---
*Related lessons: [[00-xnu-on-mobile]] | [[04-launchd-and-system-daemons]] | [[06-memory-jetsam-app-lifecycle]] | [[07-dyld-shared-cache-and-amfi]] | [[04-code-signing-amfi-entitlements]] | [[05-dynamic-analysis-with-frida]] | [[07-the-jailbreak-landscape-2026]]*
