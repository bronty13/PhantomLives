#!/bin/bash
# Reinstall the freshly-built MasterClipper.app into /Applications/.
#
# Usage:
...
SRC="$PWD/MasterClipper.app"
DST="/Applications/MasterClipper.app"
OPEN_AFTER=1
for arg in "$@"; do
    case "$arg" in
...
echo "Quitting any running MasterClipper..."
osascript -e 'tell application "MasterClipper" to quit' >/dev/null 2>&1 || true
sleep 1
