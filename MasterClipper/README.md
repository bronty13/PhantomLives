...
- **Editing Queue** — focused master/detail view of clips not yet posted. Per-row indicators for FCP project folder / production folder / length progress. Persona filter + every column sortable.
...
- **Clip audit** — seven-point checklist (ID / persona / title / refined description / categories / content date / go-live date). Live banner in the clip editor; bulk report under Reports.
