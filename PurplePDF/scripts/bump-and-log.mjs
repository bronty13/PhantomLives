#!/usr/bin/env node
/**
 * Auto-bump the patch version in PurplePDF/package.json and prepend an
 ...
 *
 * - Only fires when the staged change set touches PurplePDF/** (so commits
 *   to sibling projects don't churn the PDF app version).
