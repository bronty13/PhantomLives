#!/bin/bash
# Reinstall the freshly-built WeightTracker.app into /Applications/.
#
# Usage:
...
SRC="$PWD/WeightTracker.app"
DST="/Applications/WeightTracker.app"
OPEN_AFTER=1
for arg in "$@"; do
    case "$arg" in
...
echo "Quitting any running WeightTracker..."
osascript -e 'tell application "WeightTracker" to quit' >/dev/null 2>&1 || true
sleep 1
