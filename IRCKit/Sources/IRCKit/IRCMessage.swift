...
public struct IRCMessage: Sendable {
    ...
    public init(raw: String, tags: [String: String], prefix: String?,
    ...
    public var nickFromPrefix: String? {
    ...
    /// the spec lands.
    public var msgID: String? { tags["msgid"] ?? tags["draft/msgid"] }
    ...
    public var batchRef: String? { tags["batch"] }
...
public enum IRCSanitize {
    ...
    /// Caught by `IRCSanitizeTests.fieldStripsCRLFNUL`.
    ...
    public static func line(_ s: String) -> String { field(s) }
    ...
    public static func maskForDisplay(_ line: String) -> String {
