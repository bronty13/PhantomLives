...
/// Proxy connection parameters. Module-internal: assembled by `IRCClient` from
/// the public `IRCConnectionConfig` and handed to the framer. Apps configure
/// proxies via `IRCConnectionConfig`'s `proxy*` fields, never this type.
struct ProxyConfig {
    var type: ProxyType
    var host: String
    var port: UInt16
