...
///
/// Kept module-internal: only `IRCClient` drives it in production, and the
/// IRCKit test target reaches it via `@testable import`.
final class SASLNegotiator {
    ...
    /// session layer can probe `CAP LS` for the upper-bound parameter.
