#!/bin/bash
# Reinstall the freshly-built PurpleReel.app into /Applications/.
#
# Usage:
...
SRC="$PWD/PurpleReel.app"
DST="/Applications/PurpleReel.app"
OPEN_AFTER=1
for arg in "$@"; do
    case "$arg" in
...
echo "Quitting any running PurpleReel..."
osascript -e 'tell application "PurpleReel" to quit' >/dev/null 2>&1 || true
sleep 1
