#!/bin/bash
# Reinstall the freshly-built ElectronicDetective.app into /Applications/.
#
# Usage:
...
SRC="$PWD/ElectronicDetective.app"
DST="/Applications/ElectronicDetective.app"
OPEN_AFTER=1
for arg in "$@"; do
    case "$arg" in
...
echo "Quitting any running ElectronicDetective..."
osascript -e 'tell application "ElectronicDetective" to quit' >/dev/null 2>&1 || true
sleep 1
