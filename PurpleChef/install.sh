#!/bin/bash
# Reinstall the freshly-built Purple Chef.app into /Applications/.
#
# Usage:
...
# off the resolved bundle path. Installing to /Applications keeps a
# single stable cdhash entry across rebuilds.
set -euo pipefail
