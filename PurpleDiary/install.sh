#!/bin/bash
# Reinstall the freshly-built PurpleDiary.app into /Applications/.
#
# Usage:
...
SRC="$PWD/PurpleDiary.app"
DST="/Applications/PurpleDiary.app"
OPEN_AFTER=1
for arg in "$@"; do
    case "$arg" in
...
echo "Quitting any running PurpleDiary..."
osascript -e 'tell application "PurpleDiary" to quit' >/dev/null 2>&1 || true
sleep 1
