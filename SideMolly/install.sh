...
# Replaces /Applications/SideMolly.app with the freshly-built bundle and
...
LOCAL_APP="$PROJECT_DIR/src-tauri/target/release/bundle/macos/SideMolly.app"
INSTALL_PATH="/Applications/SideMolly.app"
...
osascript -e 'tell application "SideMolly" to quit' >/dev/null 2>&1 || true
sleep 1
...
echo "✅ SideMolly installed to $INSTALL_PATH"
