...
/// `SUEnableAutomaticChecks`); the user-facing toggle in
/// Settings → Updates flips `automaticallyChecksForUpdates` at runtime.
@MainActor
final class UpdaterController: ObservableObject {
    ...
    /// UI. Bound to the **Check for Updates…** menu item.
