#!/bin/bash
# Reinstall the freshly-built PurpleDedup.app into /Applications/.
#
# Usage:
...
SRC="$PWD/PurpleDedup.app"
DST="/Applications/PurpleDedup.app"
OPEN_AFTER=1
for arg in "$@"; do
    case "$arg" in
...
echo "Quitting any running PurpleDedup..."
osascript -e 'tell application "PurpleDedup" to quit' >/dev/null 2>&1 || true
sleep 1
