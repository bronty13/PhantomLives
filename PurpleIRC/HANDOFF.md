...
findings (2 high · 14 medium · 45 low) tracked in `AUDIT.md`; four fix
...
Four batches shipped: **1.0.590** (both HIGH items + per-network
...
slash-command bypass; 4 MEDIUM + 2 LOW), **1.0.592** (PurpleBot:
