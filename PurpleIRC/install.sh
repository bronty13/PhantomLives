...
SRC="$PWD/PurpleIRC.app"
DST="/Applications/PurpleIRC.app"
OPEN_AFTER=1
for arg in "$@"; do
    case "$arg" in
...
echo "Quitting any running PurpleIRC..."
osascript -e 'tell application "PurpleIRC" to quit' >/dev/null 2>&1 || true
sleep 1
