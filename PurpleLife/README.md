...
| 2 — Object engine + 4 views | In progress — schema registry + four list views (table/kanban/calendar/gallery) + schema editor + object detail + FTS5 + ⌘K. Cross-type link picker is the remaining piece. |
