...
- **Phase 0 (Tap Forms trial) — SKIPPED** on 2026-05-10. Decision: build. Rationale recorded in `HANDOFF.md`.
...
```mermaid
flowchart TD
    P0[Phase 0 · SKIPPED 2026-05-10<br/>decision: build · see HANDOFF.md]:::skipped
    ...
    SP[CloudKit spike · 2-day timebox<br/>encryptedValues round-trip on a toy schema<br/>runs before Phase 1 in this build]
    ...
    P0 -.-> SP --> P1 --> P2 --> P3 --> P4 --> P5
    classDef skipped fill:#eee,stroke:#999,stroke-dasharray: 5 5,color:#666
```

Realistic budget to "real use": ~3 months of personal-project time. The CloudKit spike is moved ahead of Phase 1 to de-risk the eventual sync work, since no sibling has used CloudKit before and we have no internal pattern to copy.

## Phase acceptance tests

| Phase | Gate |
|---|---|
| 0 | **Skipped** on 2026-05-10. Decision: build. See `HANDOFF.md` for the rationale. |
